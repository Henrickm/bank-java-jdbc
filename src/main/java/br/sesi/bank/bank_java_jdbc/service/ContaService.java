...
public class ContaService {
    ...
    {
            throws new RegraDeNegocioException("Já existe outra conta aberta com o mesmo número!");
    }
    ...
    public void realizarSaque(Integer numeroDaConta, BigDecimal valor) {
        ...
        if (valor.compareTo(conta.getSaldo()) > 0) {
            throw new RegraDeNegocioException("Saldo insufuciente!");
        }
    ...
    public void realizarDeposito(Integer numeroDaConta, BigDecimal valor) {
        var conta = buscarContaPorNumero(numeroDaConta);
        if (valor.compareTo(BigDecimal.ZERO) <= 0) {
            throw new RegraDeNegocioException("Valor do deposito deve ser suoerior a zero!");
        }
